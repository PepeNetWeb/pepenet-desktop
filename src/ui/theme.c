...
// 11: metadata must be legible, hierarchy below 13 is carried by color
// (ghost/dim), not size.
static const struct { unsigned char src; float size; unsigned merges; } FACE[F_COUNT] = {
    ...
    [F_SM10]  = { SRC_SMR, 12, M_SYM | M_COIN | M_UIEMO },
    [F_SM9]   = { SRC_SMR, 11, M_SYM | M_COIN | M_UIEMO },
    [F_SMB10] = { SRC_SMB, 12, M_SYM | M_COIN | M_UIEMO },
    [F_SMB9]  = { SRC_SMB, 11, M_SYM | M_COIN | M_UIEMO },
};
